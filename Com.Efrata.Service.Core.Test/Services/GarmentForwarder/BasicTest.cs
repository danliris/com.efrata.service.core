...
namespace Com.Ambassador.Service.Core.Test.Services.GarmentForwarder
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentForwarder";
        ...
        private GarmentForwarderDataUtil _dataUtil(GarmentForwarderService service)
        {
            return new GarmentForwarderDataUtil(service);
        }
        ...
        {
            var service = new GarmentForwarderService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentForwarderViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentForwarderService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentForwarderService)))
                .Returns(service);
