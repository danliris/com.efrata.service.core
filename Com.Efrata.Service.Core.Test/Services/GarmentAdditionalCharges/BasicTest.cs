...
namespace Com.Ambassador.Service.Core.Test.Services.GarmentAdditionalCharges
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentAdditionalCharges";
        ...
        private GarmentAdditionalChargesDataUtil _dataUtil(GarmentAdditionalChargesService service)
        {
            return new GarmentAdditionalChargesDataUtil(service);
        }
        ...
        {
            var service = new GarmentAdditionalChargesService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentAdditionalChargesViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentAdditionalChargesService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentAdditionalChargesService)))
                .Returns(service);
