...
namespace Com.Ambassador.Service.Core.Test.Services.GarmentTransactionType
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentTransactionType";
        ...
        private GarmentTransactionTypeDataUtil _dataUtil(GarmentTransactionTypeService service)
        {
            return new GarmentTransactionTypeDataUtil(service);
        }
        ...
        {
            var service = new GarmentTransactionTypeService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
