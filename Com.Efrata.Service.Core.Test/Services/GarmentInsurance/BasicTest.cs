...
namespace Com.Ambassador.Service.Core.Test.Services.GarmentInsurance
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentInsurance";
        ...
        private GarmentInsuranceDataUtil _dataUtil(GarmentInsuranceService service)
        {
            return new GarmentInsuranceDataUtil(service);
        }
        ...
        {
            var service = new GarmentInsuranceService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentInsuranceViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentInsuranceService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentInsuranceService)))
                .Returns(service);
