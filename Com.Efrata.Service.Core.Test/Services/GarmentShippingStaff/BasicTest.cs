...
namespace Com.Ambassador.Service.Core.Test.Services.GarmentShippingStaff
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentShippingStaff";
        ...
        private GarmentShippingStaffDataUtil _dataUtil(GarmentShipingStaffService service)
        {
            return new GarmentShippingStaffDataUtil(service);
        }
        ...
        {
            var service = new GarmentShipingStaffService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentShippingStaffViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentShipingStaffService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentShippingStaffService)))
                .Returns(service);
