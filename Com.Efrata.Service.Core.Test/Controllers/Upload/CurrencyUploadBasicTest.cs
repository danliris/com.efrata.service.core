...
namespace Com.Ambassador.Service.Core.Test.Controllers.Upload
{
    ...
    public class CurrencyUploadBasicTest
    {
        private const string URI = "v1/master/upload-currencies";
        ...
        public async Task Should_Success_Upload_CSV_Using_Memory_Stream()
        {
            ...
            string guid = Guid.NewGuid().ToString();
            string header = "Kode,Simbol,Rate,Keterangan";
            string content1 = "AAA,RP,1,Keterangan";
            string content2 = "AAA,RP,1,Keterangan";
